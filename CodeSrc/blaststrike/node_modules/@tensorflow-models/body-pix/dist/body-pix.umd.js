...
(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     */
    var PART_NAMES = [
        'head', 'leftShoulder', 'rightShoulder', 'leftWrist', 'rightWrist',
    ...
    var CONNECTED_PART_NAMES = [
        ['leftHip', 'leftShoulder'], ['leftWrist', 'leftShoulder'],
        ['leftHip', 'leftAnkle'], ['rightHip', 'rightShoulder'],
        ['rightWrist', 'rightShoulder'], ['rightHip', 'rightAnkle'],
     ...
     */
    var POSE_CHAIN = [
        ['head', 'leftShoulder'], ['leftShoulder', 'leftWrist'],
        ['leftShoulder', 'leftHip'], ['leftHip', 'leftAnkle'],
        ['head', 'rightShoulder'], ['rightShoulder', 'rightWrist'],
        ['rightShoulder', 'rightHip'], ['rightHip', 'rightAnkle']
    ];
    ...
    var BodyPix = /** @class */ (function () {
         ...
         * before it is fed into the model.
         */
        BodyPix.prototype.Activation = function (input, internalResolution, segmentationThreshold) {
            var _this = this;
            if (segmentationThreshold === void 0) { segmentationThreshold = 0.5; }
            var _a = getInputSize(input), height = _a[0], width = _a[1];
            var internalResolutionHeightAndWidth = toInputResolutionHeightAndWidth(internalResolution, this.baseModel.outputStride, [height, width]);
