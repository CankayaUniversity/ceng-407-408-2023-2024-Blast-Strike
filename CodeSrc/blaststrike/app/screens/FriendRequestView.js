...
const URL = 'http://192.168.1.102:4000/fetchCurrentUserData';
...
const FriendRequestsView = () => {
  ...
  const acceptRequest = async () => {
    ...
    try
    {
      ...
      const response = await axios.post('http://192.168.1.102:4000/addFriends', {
        ...
        const deleteAcceptedRequest = await axios.post('http://192.168.1.102:4000/deleteAcceptedRequests',
        {
          data:
          {
            from_username:fromUsername,
